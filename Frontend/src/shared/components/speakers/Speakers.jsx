        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6">
            ...
            <div className="bg-white rounded-lg shadow-md overflow-hidden">
              <img src="public/assets/images/Home/Martniez.jpg" alt="Martinez Fernandez" className="w-full" />
              <div className="p-4">
            ...
            {/* Speaker 2 */}
            <div className="bg-white rounded-lg shadow-md overflow-hidden">
              <img src="public/assets/images/Home/tamil.jpg" alt="Tamil Azhagan" className="w-full" />
              <div className="p-4">
            ...
            {/* Speaker 3 */}
            <div className="bg-white rounded-lg shadow-md overflow-hidden">
              <img src="public/assets/images/Home/mus.jpg" alt="Malik Musamir" className="w-full" />
              <div className="p-4">
            ...
            {/* Speaker 4 */}
            <div className="bg-white rounded-lg shadow-md overflow-hidden">
              <img src="public/assets/images/Home/dravid.jpg" alt="Dravidian" className="w-full" />
              <div className="p-4">
